module GamesHelper
  ...
  def player_game_link me, g
    p1,p2 = g.plays
    p2,p1 = p1,p2 if me == p2.player 
    link_to "#{p1.character.name.titleize} #{win_loss_phrase(p1.win)} #{p2.character.name.titleize} (#{p2.player.name.titleize})", g     
  end
  def character_game_link me, g
    p1,p2 = g.plays
